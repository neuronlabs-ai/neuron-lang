...
& NEURON Native JIT & 1 & 490.97 \\
& PyTorch CPU (1 Thread) & 1 & 237.28 \\
& Python + NumPy (f64) & Multi & 175.23 \\
& PyTorch CPU (Multi-Thread) & Multi & 163.19 \\
\midrule
MLP Backprop (100 steps) & NEURON VM (Interpreted) & 1 & 351.22 \\
& NEURON Native JIT & 1 & 443.05 \\
& PyTorch CPU (1 Thread) & 1 & 239.39 \\
& PyTorch CPU (Multi-Thread) & Multi & 397.32 \\
\bottomrule
\end{tabular}
\end{table}
