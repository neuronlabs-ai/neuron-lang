...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item Binary operations combining two temporal streams $a : \ty{Temporal}[T, \Delta_1]$ and $b : \ty{Temporal}[T, \Delta_2]$ yield a conservative alignment boundary $\Delta_{\text{res}} = \min(\Delta_1, \Delta_2)$.
...
\textbf{Future work.} Multi-device and distributed GPU execution, and formal soundness proof.
